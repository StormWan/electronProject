    ...
    <el-row>
      ...
      <el-col :lg="9" :md="12" :sm="24" :xl="9" :xs="24">
        ...
        >
          ...
          <el-form-item>
            <span @click="toLogin" style="color: #409eff">注册</span>
...
<script setup>
import { ref, reactive, onBeforeRouteLeave, watch } from "vue";
...
// const { setUserToken, setNickname, getUserSig, getTenantId, getUserId, getUserLevel } = userStore;
