    ...
    <el-row>
      ...
      <el-col :lg="9" :md="12" :sm="24" :xl="9" :xs="24">
        ...
        >
          ...
          <el-form-item v-show="step === 0" prop="company" label="企业名字">
            <el-input
              v-model.trim="form.company"
              v-focus
              auto-complete="off"
              :placeholder="translateTitle('请输入企业名字')"
              type="text"
            />
          </el-form-item>
          <el-form-item v-show="step === 0" prop="industry" label="行业">
          ...
          <el-form-item v-show="step === 1 && !isChangePone" prop="email" label="登陆邮箱">
            <el-input
              v-model.trim="form.email"
              :placeholder="translateTitle('请输入登录邮箱')"
              type="text"
            />
          </el-form-item>
          <el-form-item v-show="step === 1 && !isChangePone" prop="password" label="密码">
            <el-input
          ...
          <el-form-item v-show="step === 1" prop="phone" label="手机号码">
            <el-input
          ...
          <el-form-item v-show="step === 1" prop="verificationCode" label="验证码">
            <el-input
            ...
            <div class="code">
              ...
              <div v-else>{{ translateTitle("加载中") }}</div>
            </div>
          </el-form-item>
          <el-form-item
