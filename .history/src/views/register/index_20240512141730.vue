    ...
    <el-row>
      ...
      <el-col :lg="9" :md="12" :sm="24" :xl="9" :xs="24">
        ...
        >
          ...
          <div v-show="step === 2" class="last-tips">已发送短信验证码到: {{ form.phone }}</div>

          <template v-if="step == 1">
            <div class="last-title">请完善信息</div>
          </template>
          ...
          <el-form-item v-show="step === 0" prop="industry">
            <el-select
              ...
              placeholder="请选择行业"
              style="min-height: 48px; line-height: 48px"
            >
              <el-option
          ...
          <el-form-item v-show="step === 1 && !isChangePone" prop="remark">
            <el-input
          ...
          <div style="display: inline-flex; align-items: center" v-show="step === 2">
