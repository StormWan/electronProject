    ...
    <el-row>
      ...
      <el-col :lg="9" :md="12" :sm="24" :xl="9" :xs="24">
        <el-form ref="formRef" class="login-form" :model="form" :rules="rules" label-position="top">
          ...
          <el-form-item v-if="step == 0" prop="loginAcct">
            <el-input
              v-model.trim="form.loginAcct"
              v-focus
              placeholder="请用你的邮箱地址登录账户"
              tabindex="1"
              type="text"
            />
          </el-form-item>
          <el-form-item v-if="step == 0" prop="password">
            <el-input
          ...
          <el-form-item v-if="step == 1" prop="toAddress">
            <el-input
          ...
          <div style="display: inline-flex; align-items: center" v-if="step !== 1">
          ...
          <el-form-item>
            ...
            <el-row style="width: 100%" flex justify="space-between">
              <el-col span="12">
                <span @click="toRegister" style="color: #409eff; cursor: pointer">注册</span>
              </el-col>
              <el-col span="12">
                <span @click="toResetpasseord" style="color: #409eff; cursor: pointer">注册</span>
              </el-col>
              <el-col v-if="step === 0" span="12">
                <span style="color: #909399; cursor: pointer" @click="handleChangeStep(1)">
                  找回密码
                </span>
              </el-col>
            </el-row>
...
const toResetpasseord = () => {
  router.push({ path: "/resetPassword", query: { email: "1623985631@qq.com", code: "423243" } });
};
