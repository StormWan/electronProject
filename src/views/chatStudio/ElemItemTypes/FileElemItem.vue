...
import HandleFolder from "@/electron/components/HandleFolder/index.vue";
import { checkFileExist } from "@/electron/utils/folder";
...
onMounted(() => {
  ...
  isExist.value = checkFileExist(payload.fileName);
});
onBeforeUnmount(() => {
